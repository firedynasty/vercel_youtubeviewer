...
(function () {
  ...
  window.FAMOUS_BEATS_PRESETS = [
    ...
    },
    {
      ...
      kick: pattern([0,1,3,5,6]),
      snare: pattern([]),
      hat: pattern([1,2,3,4,5,6,7]),
      crash: pattern([]),
      tone: pattern([])
    },
    {
    ...
    },
    {
      ...
      kick: pattern([0,3,4,7]),
      snare: pattern([2,6]),
      hat: pattern([0,1,2,3,4,5,6,7]),
      crash: pattern([]),
      tone: pattern([0,1,2,3,4,5,6,7])
    },
    {
    ...
    },
    {
      ...
      kick: pattern([4,5,6,7]),
      snare: pattern([4,5,6,7]),
      hat: pattern([]),
      crash: pattern([4]),
      tone: pattern([0])
    },
    ...
    },
    {
      ...
      kick: pattern([0,1,3,5]),
      snare: pattern([4]),
      hat: pattern([0,1,2,4,5,6,7]),
      crash: pattern([0]),
      tone: pattern([0,6])
    },
    {
    ...
    },
    {
      ...
      bpm: 53,
      desc: "Dusty boom-bap swing with a lazy late kick and constant soft hats to hold a smooth flow state, ultimate focus lofi hip hop.",
      kick: pattern([0,5,6,7]),
      snare: pattern([2,4]),
      hat: pattern([0,1,2,3,4,5]),
      crash: pattern([]),
      tone: pattern([1,3,5])
    },
    {
    ...
    },
    {
      ...
      bpm: 53,
      desc: "Driving 80s synthwave pulse — relentless downbeat kick and offbeat hats pushing forward like a neon highway.",
      kick: pattern([0,2,3,5,6]),
      snare: pattern([2,5]),
      hat: pattern([1,4,7]),
      crash: pattern([]),
      tone: pattern([1,3,4,6])
    },
    {
      name: "Chillwave Haze",
      bpm: 92,
